...
def evaluate(logdir, save_predict=False):
    ...
    # oo = torch.load('/home/yangenquan/PycharmProjects/第三论文尝试/project_fourth-最终/run/2022-05-21-13-59/model_best.pth')
    # print(oo.keys())
    # print(oo.load_state_dict('/home/yangenquan/PycharmProjects/第三论文尝试/project_fourth-最终/run/2022-05-21-13-59/model_best.pth'))
    # # for i in oo:
    # #     print(i)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--logdir", type=str, help="run logdir", default="run/2022-06-02-08-59/")
